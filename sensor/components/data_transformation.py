...
class DataTransformation:
    ...
    def __init__(self,data_transformation_config:config_entity.DataTransformationConfig,
                    data_ingestion_artifact:artifacts_entity.DataIngestionArtifacts):
    ...
    def initiate_data_transformation(self,)->artifacts_entity.DataTransformationArtifact:
        try:
            ...
            #selecting target feature for training and test dataframe
            ...
            inputtransformation_pipeline.fit(input_feature_train_df)
            
            #transforming input features
            input_feature_train_arr = transformation_pipeline.transform(input_feature_train_df)
            input_feature_test_arr = transformation_pipeline.transform(input_feature_test_arr)
