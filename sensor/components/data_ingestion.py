...
class DataIngestion:
    ...
    def initiate_data_ingestion(self)->artifacts_entity.DataIngestionArtifacts:
        try:
            ...
            logging.info(f"Create Feature store folder if not exists")
            ...
            logging.info(f"Split dataset into train test")
